...
A complete prompt and commit appendix is available in:
\begin{itemize}
  \item \url{https://github.com/shmish111/codex-marlowe-rust/blob/main/APPENDIX_PROMPTS_AND_COMMITS.md}
\end{itemize}

For review readability, the full logs are kept as a separate artifact rather than embedded directly in this PDF.
